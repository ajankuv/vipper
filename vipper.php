...
class Vipper extends Module
{
	public function __construct()
	{
		...
		$this->version = '1.0';
		$this->author = 'Arian Kooshesh';

		parent::__construct();

		$this->displayName = $this->l('Vip Module');
		$this->description = $this->l('Vip Stuff.');
...
//		return $this->display(__FILE__, 'right.tpl');
	...
	{
		$this->context->smarty->assign(array(
			'module_link' => $this->context->link->getModuleLink('vipper', 'details'),
		));
...
//		return $this->display(__FILE__, 'footer.tpl');
	...
	private function _saveContent()
	{
		...
		if (Configuration::updateValue('MOD_API_KEY', Tools::getValue('MOD_API_KEY'))  )
	...
	{
		if (!Configuration::deleteByName('MOD_API_KEY')  )
			return false;
		return true;
